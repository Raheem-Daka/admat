...
const DesignCard = () => {
    ...
    useEffect(() => {
        fetch("http://127.0.0.1:800/api/products/")
        .then((response) => {
            if (!response.ok) {
        ...
        <div className="container mx-auto p-4">
            <section class="bg-white flex items-center justify-center px-4 py-16">
                <div class="flex flex-wrap items-stretch justify-center gap-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 border border-zinc-200 hover:border-zinc-300 transition-colors rounded-xl p-2 flex flex-col w-46">
